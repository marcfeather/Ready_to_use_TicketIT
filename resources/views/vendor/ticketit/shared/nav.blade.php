            ...
            @if($u->isAdmin())
                ...
                <li role="presentation" class="dropdown {!!
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li role="presentation"  class="{!! $tools->fullUrlIs(action('\App\Http\Controllers\UserController@index').'*') ? "active" : "" !!}">
                            <a href="{{ action('\App\Http\Controllers\UserController@index')}}">{{ trans('ticketit::admin.nav-users') }}</a>
                        </li>
